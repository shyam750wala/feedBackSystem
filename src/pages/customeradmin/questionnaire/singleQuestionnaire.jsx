...
function SingleQuestionnaire() {
    ...
    // useEffect(() => {
    //     // Load checked categories from local storage on component mount
    //     const savedCheckedCategories = JSON.parse(localStorage.getItem('checkedCategories'));
    //     if (savedCheckedCategories) {
    //         setFetchedCategories(savedCheckedCategories);
    //     }
    // }, []);

    // useEffect(() => {
    //     // Update local storage whenever fetchedCategories state changes
    //     localStorage.setItem('checkedCategories', JSON.stringify(fetchedCategories));
    // }, [fetchedCategories]);
